#!/usr/bin/env python3
"""Upload the fixed package to GitHub Release."""
...
TAG_NAME = "v1.4.5"
RELEASE_NAME = "v1.4.5 - 源管理系统增强版 (修复版)"
...
- 📈 **性能监控** - 实时统计和健康检查
- 🧪 **完整测试套件** - 44个单元和集成测试
- 🔧 **修复包结构问题** - 使用正确的Synology Video Station插件格式
...
# Check and get existing release
print("\n检查现有Release...")
